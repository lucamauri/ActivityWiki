 ...
 * the MediaWiki Config service via the constructor.
 */
class ActivityPubModule {
     ...
     *
     * The "publicKey" field is intentionally left as a placeholder here.
     * It will be populated in Phase 2 (Layer 2 — Security) once RSA key
     * generation and storage are implemented. Leaving it as an empty string
     * is spec-compliant for now but means Mastodon will reject incoming
     * activities until Phase 2 is complete.
     *
    ...
    public function buildActorObject(): array {
        ...
        return [
            ...
            // activities. Populated in Phase 2 (Layer 2 — Security).
            // Until then this is a valid but empty placeholder.
            'publicKey' => [
                'id'           => $actorUrl . '#main-key',
                'owner'        => $actorUrl,
                // @todo Phase 2: replace with real PEM from activitywiki_keys table.
                'publicKeyPem' => '',
            ],
        ];
    }
